...
* A reflective presentation by Paola Di Maio (AI KR CG) on the system level intersection of reasoning as proposed in the CogAI framework vs reasoning in knowledge representation and ontology, with ponters to pragmatic state of the art and future outlook considerations
